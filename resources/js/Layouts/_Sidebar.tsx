                ...
                <div className="h-full overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 mt-3">
                    ...
                    >
                        <ul className="flex flex-col space-y-1">
                            ...
                            <li>
                                <a
                                    className="w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 dark:text-slate-200 rounded-lg hover:bg-gray-100 dark:hover:bg-neutral-800 dark:hover:text-neutral-400"
                                    href="#"
                                >
                                    <svg
                                        className="shrink-0 size-4"
